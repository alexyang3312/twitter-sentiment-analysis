...
# master是环境，local代表本地环境，local[*]代表所有线程，local代表使用1个线程。
# master is a Spark, Mesos or YARN cluster URL, or a special “local” string to run in local mode.

# 建立与Spark的连接，每运行一次都会新创建一个SparkContext。
...
parquetFile = r"/Users/yangminghan/Desktop/大数据推特美国大选/word2vecM_simple2/data/part-r-00000-5d5e245e-1d0c-4281-9274-145495a3565f.snappy.parquet"
